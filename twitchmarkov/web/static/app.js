...
(function () {
  ...
  const SETTINGS_FIELDS = [
    ...
    { key: "percent_unique", label: "Uniqueness threshold (%)", type: "float", min: 0, max: 100, step: 0.1, help: "Minimum percentage of unique words an incoming chat message needs before it is learned." },
    { key: "allow_mentions", label: "Keep @mentions", type: "bool", help: "Keep @mentions in incoming messages when learning them. Off strips them before storing." },
    { key: "state_size", label: "Markov state size", type: "int", min: 1, max: 5, help: "Number of prior words used to choose the next word." },
    { key: "times_to_try", label: "Generation attempts", type: "int", min: 1, help: "How many attempts markovify makes to build a sentence from the corpus." },
    { key: "cull_over", label: "Cull corpus over (messages)", type: "int", min: 1, help: "Trim the corpus once it grows past this many messages." },
    { key: "time_to_cull", label: "Seconds between culls", type: "int", min: 0, help: "Seconds that must pass before the corpus is culled again; checked after each generated message. 0 culls after every generation." },
    { key: "cooldown_speak", label: "Cooldown: !speak (seconds)", type: "int", min: 0, help: "Minimum time between !speak uses." },
    { key: "cooldown_commands", label: "Cooldown: !commands (seconds)", type: "int", min: 0, help: "Seconds between !commands replies in chat." },
